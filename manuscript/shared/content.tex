...
The network metric analysis covers five centrality measures computed on undirected graph data, and community structure can be revealed through Louvain community detection mapped onto visual groups. Directed-graph metrics are not yet supported. Similarily, path-based analyses, for example tracing the shortest path between selected features to reveal entity interaction or signaling chains, are not yet implemented, although GLL already computes shortest paths internally for centrality measures, making this a natural extension.

...
let excelData = {
  s: {
    readme: {
      d: [
        [0, 0, 'Color Codes Explained'],
        [0, 1, 'Description'],
        [1, 0, 'Required'],
        [1, 1, 'Strictly required property'],
        [2, 0, 'Optional'],
        [2, 1, 'Optional property; Column name can not be re-used for user-defined data'],
        [3, 0, 'User Data [group]'],
        [
          3,
          1,
        ...
        [5, 0, 'Data Types Explained'],
        [5, 1, 'Description'],
        [6, 0, 'text'],
        [6, 1, 'any text'],
        [7, 0, 'number'],
        [7, 1, 'whole decimal numbers or floating point numbers'],
        [8, 0, 'boolean'],
        [8, 1, 'true or TRUE or 1, false or FALSE or 0'],
        [9, 0, 'RGBA'],
        [9, 1, 'RGBA hex color code (e.g. #C33D3580 for 50% opacity) (last 2 digits are optional)'],
        [10, 0, 'value 1 | value 2'],
        [
          10,
          1,
        ...
        [13, 0, 'Node Properties Explained'],
        [13, 1, 'Description'],
        [13, 2, 'Default Value'],
        [13, 3, 'Type'],
        [14, 0, 'ID'],
        [14, 1, 'Unique identifier for a node'],
        [14, 2, '-'],
        [14, 3, 'text (unique)'],
        [15, 0, 'Label'],
        [15, 1, 'Label of the node; if no Label is given, the ID is displayed per default'],
        [15, 2, '-'],
        [15, 3, 'text'],
        [16, 0, 'Description'],
        [16, 1, 'Description of the node, displayed in the tooltip text'],
        [16, 2, '-'],
        [16, 3, 'text'],
        [17, 0, 'Shape'],
        [17, 1, 'The shape of the node'],
        [17, 2, 'hexagon'],
        [17, 3, 'circle (●) | diamond (◆) | hexagon (⬢) | rect (■) | triangle (▲) | star (★)'],
        [18, 0, 'Size'],
        [18, 1, 'The size of the node'],
        [18, 2, '20'],
        [18, 3, 'number'],
        [19, 0, 'Fill Color'],
        [
        ...
        [19, 3, 'rgba'],
        [20, 0, 'Border Size'],
        [20, 1, 'The stroke width'],
        [20, 2, '1'],
        [20, 3, 'number'],
        [21, 0, 'Border Color'],
        [21, 1, 'The stroke color of the node in RGBA format'],
        [21, 2, '-'],
        [21, 3, 'rgba'],
        [22, 0, 'Label Font Size'],
        [22, 1, 'Label font size'],
        [22, 2, '12'],
        [22, 3, 'number'],
        [23, 0, 'Label Placement'],
        [23, 1, 'Label position relative to the main shape of the node'],
        [23, 2, 'bottom'],
        [
          23,
          3,
        ...
        [24, 0, 'Label Color'],
        [24, 1, 'The color of the nodes label'],
        [24, 2, '-'],
        [24, 3, 'rgba'],
        [25, 0, 'Label Background Color'],
        [25, 1, 'Label background fill color'],
        [25, 2, '-'],
        [25, 3, 'rgba'],
        [26, 0, 'X Coordinate'],
        [26, 1, 'The x coordinate of the node'],
        [26, 2, '-'],
        [26, 3, 'number'],
        [27, 0, 'Y Coordinate'],
        [27, 1, 'The y coordinate of the node'],
        [27, 2, '-'],
        [27, 3, 'number'],
        [28, 0, 'property A [group A]'],
        [28, 1, 'User-defined custom node properties'],
        [28, 2, '-'],
        [28, 3, 'any'],
        [30, 0, 'Edge Properties Explained'],
        [30, 1, 'Description'],
        [30, 2, 'Default Value'],
        [30, 3, 'Type'],
        [31, 0, 'Source ID'],
        [31, 1, 'The ID of the source node'],
        [31, 2, '-'],
        [31, 3, 'text'],
        [32, 0, 'Target ID'],
        [32, 1, 'The ID of the target node'],
        [32, 2, '-'],
        [32, 3, 'text'],
        [33, 0, 'Label'],
        [
        ...
        [33, 3, 'text'],
        [34, 0, 'Description'],
        [34, 1, 'Description of the edge, displayed in the tooltip text'],
        [34, 2, '-'],
        [34, 3, 'text'],
        [35, 0, 'Type'],
        [35, 1, 'The edge type'],
        [35, 2, 'line'],
        [35, 3, 'line | cubic | quadratic | polyline'],
        [36, 0, 'Line Width'],
        [36, 1, 'The border width of the edge'],
        [36, 2, '0.75'],
        [36, 3, 'number'],
        [37, 0, 'Line Dash'],
        [37, 1, 'The dash offset of the edge line'],
        [37, 2, '0'],
        [37, 3, 'number'],
        [38, 0, 'Color'],
        [38, 1, 'The stroke color of the edge in RGBA format'],
        [38, 2, '#403C5390'],
        [38, 3, 'rgba'],
        [39, 0, 'Label Font Size'],
        [39, 1, 'The font size of the edges label'],
        [39, 2, 'center'],
        [39, 3, 'number'],
        [40, 0, 'Label Placement'],
        [40, 1, 'The position of the label relative to the edge'],
        [40, 2, '#000000'],
        [40, 3, 'start | center | end'],
        [41, 0, 'Label Auto Rotate'],
        [41, 1, 'Whether to automatically rotate the label to match the edge’s direction'],
        [41, 2, '1'],
        [41, 3, 'boolean'],
        [42, 0, 'Label Offset X'],
        [42, 1, 'The offset of the label on the X-Axis'],
        [42, 2, '0'],
        [42, 3, 'number'],
        [43, 0, 'Label Offset Y'],
        [43, 1, 'The offset of the label on the Y-Axis'],
        [43, 2, '0'],
        [43, 3, 'number'],
        [44, 0, 'Label Color'],
        [44, 1, 'The color of the edges label text'],
        [44, 2, '-'],
        [44, 3, 'rgba'],
        [45, 0, 'Label Background Color'],
        [45, 1, 'The color for the edge label’s background'],
        [45, 2, '#E4E3EA'],
        [45, 3, 'rgba'],
        [46, 0, 'Start Arrow'],
        [46, 1, 'Whether to display the start arrow on the edge'],
        [46, 2, { formula: 'FALSE()' }],
        [46, 3, 'boolean'],
        [47, 0, 'Start Arrow Size'],
        [47, 1, 'The size of the start arrow'],
        [47, 2, '8'],
        [47, 3, 'number'],
        [48, 0, 'Start Arrow Type'],
        [48, 1, 'The type of the start arrow'],
        [48, 2, 'triangle'],
        [48, 3, 'triangle | circle | diamond | vee | rect | triangleRect | simple'],
        [49, 0, 'End Arrow'],
        [49, 1, 'Whether to display the end arrow on the edge'],
        [49, 2, { formula: 'FALSE()' }],
        [49, 3, 'boolean'],
        [50, 0, 'End Arrow Size'],
        [50, 1, 'The size of the end arrow'],
        [50, 2, '8'],
        [50, 3, 'number'],
        [51, 0, 'End Arrow Type'],
        [51, 1, 'The type of the end arrow'],
        [51, 2, 'triangle'],
        [51, 3, 'triangle | circle | diamond | vee | rect | triangleRect | simple'],
      ],
      st: {
        A1: 0,
        B1: 0,
    ...
    nodes: {
      d: [
        ...
        [0, 5, 'Fill Color'],
        [0, 6, 'Border Color'],
        [0, 7, 'Feature X [group A]'],
        [0, 8, 'Feature Y [nm] [group A]'],
        [0, 9, 'Feature Z [group B]'],
        [1, 0, 'A'],
        [1, 1, 'Node 1'],
        [1, 2, 'The first node'],
        [1, 3, 'circle'],
    ...
    edges: {
      d: [
        ...
        [0, 3, 'Line Width'],
        [0, 4, 'Label'],
        [0, 5, 'Feature EX [group X]'],
        [0, 6, 'Feature EY [group X]'],
        [0, 7, 'Feature EZ [group Y]'],
        [1, 0, 'A'],
        [1, 1, 'B'],
        [1, 2, '#FF0000'],
        [1, 3, '0.75'],
        [1, 4, 'foo'],
        [1, 5, '1'],
        [1, 6, 'Dummy Category 1'],
        [1, 7, '1'],
        [2, 0, 'A'],
        [2, 1, 'C'],
        [2, 5, '0.5'],
        [2, 6, 'Dummy Category 2'],
        [2, 7, '2'],
        [3, 0, 'C'],
        [3, 1, 'D'],
        [3, 5, '1.1'],
        [3, 6, 'Dummy Category 3'],
        [3, 7, '1'],
        [4, 0, 'D'],
        [4, 1, 'E'],
        [4, 5, '1.3'],
        [4, 6, 'Dummy Category 4'],
        [4, 7, '0'],
      ],
      st: {
        A1: 3,
...
class IOManager {
  ...
  populateFilterPropsLowsAndHighs(propHash, nodeOrEdgeValue) {
    ...
    if (
      !this.cache.data.filterDefaults.get(propHash).hasFloatValues &&
      !StaticUtilities.isInteger(nodeOrEdgeValue)
    ) {
      this.cache.data.filterDefaults.get(propHash).hasFloatValues = true;
    }
    this.cache.data.filterDefaults.get(propHash).lowerThreshold = Math.min(
      nodeOrEdgeValue,
      this.cache.data.filterDefaults.get(propHash).lowerThreshold
    );
    this.cache.data.filterDefaults.get(propHash).upperThreshold = Math.max(
      nodeOrEdgeValue,
      this.cache.data.filterDefaults.get(propHash).upperThreshold
    );
  }
